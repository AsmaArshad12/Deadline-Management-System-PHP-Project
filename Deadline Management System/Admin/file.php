...
<body>
    ...
    <div id="main-wrapper">     
        ...
        <div class="page-wrapper">
            ...
            <form method="post"  style="font-size: 13px;">
                ...
                <span class="text-danger h5"><?php if(isset($search_error)) {echo $search_error;} ?>
                    ...
                    <div class="col-lg-12 mb-6 mt-6" style="margin-left:500px"> 
        ...
        {
        ?>
        <div id="delete_task_modal" class="modal">                      

<span onclick="document.getElementById('delete_task_modal').style.display='none'" class="close" title="Close Modal">×</span>  
  <div class="container">
    <h1 style="color: white;">Delete Task</h1><br>
    <h3 style="color: white;">Are you sure you want to delete this Task?</h3><br> 
    <div class="clearfix">        
      <button type="button" onclick="document.getElementById('delete_task_modal').style.display='none'" class="cancelbtn">Cancel</button>
      <a role="button" href="Delete_Task.php?id=<?php echo $row['Task_ID']; ?>"><button id="<?php echo $row['Task_ID'];?>" type="button" class="deletebtn" onclick="document.getElementById('delete_task_modal').style.display='none'">Delete</button></a>
    </div>
  </div>  
</div>
            <tr>
                <td><a  role="button" href="Update_Task_By_Admin.php?id=<?php echo $row['Task_ID']; ?>"><span style="color: blue; font-size: 15px;" class="m-r-10 mdi mdi-grease-pencil"></span></a>&nbsp;&nbsp;<span style="color: red; font-size: 15px;" class="m-r-10 mdi mdi-delete-sweep" onclick="document.getElementById('delete_task_modal').style.display='block'"></span></td>
...
// Get the modal
var modal = document.getElementById('delete_task_modal');
